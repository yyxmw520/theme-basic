  ...
  <NuxtLayout v-else name="default">
    <div class="fixed top-0 z-50 w-full flex items-center justify-center bg-white border-b border-gray-100 shadow-sm">
      <div class="w-full bg-white px-4"
        ...
        <div class="flex items-center h-16 justify-between gap-x-2">
          <div class="flex items-center justify-center bg-white gap-x-1.5 min-w-0 flex-shrink">
            <svg class="w-6 h-6 sm:w-7 sm:h-7 text-blue-600 flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
              viewBox="0 0 24 24">
            ...
            <NuxtLink :to="localePath('/')" class="merchant-name text-base sm:text-lg font-medium truncate max-w-[100px] sm:max-w-none">
          ...
          <div class="flex items-center space-x-1.5 sm:space-x-2 flex-shrink-0">
            ...
            <a 
              ...
              class="btn btn-xs sm:btn-sm text-white font-medium rounded-lg flex items-center gap-1 shadow-sm hover:opacity-90 transition-all cursor-pointer whitespace-nowrap px-2 sm:px-3 text-xs"
              style="background-color: #fb7299; border: none; height: 32px; line-height: 32px;"
            >
            ...
            <NuxtLink :to="localePath('/order/search')" class="btn btn-xs sm:btn-sm btn-outline rounded-md px-2 sm:px-3 text-xs whitespace-nowrap">
